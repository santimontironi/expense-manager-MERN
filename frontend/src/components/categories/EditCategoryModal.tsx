        ...
        >
            ...
            >
                ...
                <form className="mt-7 flex flex-col gap-5" onSubmit={handleSubmit(submitForm)}>
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="spendingLimit" className="text-sm font-normal text-ink/70">
                        ...
                        <div className="flex items-center gap-3 rounded-xl border border-ink/15 px-4 py-3 transition-colors focus-within:border-secondary focus-within:ring-2 focus-within:ring-secondary/20">
                            ...
                            <input
                                ...
                                {...register("spendingLimit", {
                                    required: "Ingresá un límite de gasto",
                                    valueAsNumber: true,
                                    min: { value: 0.01, message: "El límite de gasto debe ser mayor a 0" },
                                })}
                            />
                        </div>
                        {errors.spendingLimit && (
                            <span className="text-sm text-red-600">{errors.spendingLimit.message}</span>
                        )}
                    </div>
